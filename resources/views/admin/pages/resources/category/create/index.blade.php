            ...
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-12">
                    <div class="flex items-center gap-x-4">
                        ...
                        <div class="flex items-center mb-4">
                            <input name="as_page" id="as_page" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="as_page" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Sayfayı Temsil Ediyor</label>
                        </div>
                        <div class="flex items-center mb-4">
